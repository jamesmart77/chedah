...
freelance gig, your side hustle, all your entreprenuerial endeavors</h6>
        ...
        <div className="row header2">
          ...
          <ul className="landingList">
            <li><h6><i className="material-icons tiny">check_circle</i> Simple expense and payment tracking for every project you're working on.</h6></li>
            <li><h6><i className="material-icons tiny">check_circle</i> Capture all the information you need to reveal your most profitable projects.</h6></li>
            <li><h6><i className="material-icons tiny">check_circle</i> Streamline your workflow with one dashboard to rule them all.</h6></li>
            <li><h6><i className="material-icons tiny">check_circle</i> Create goals and easily monitor results. </h6></li>
            <li><h6><i className="material-icons tiny">check_circle</i> Take control of your finances - no complicated accounting software needed. </h6></li>
