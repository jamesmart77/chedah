              ...
              <div className='account-detail-header'>
                <div className='row valign-wrapper'>
                  ...
                  <div className='col s12 m6 right-align'>
                    <span className='account-avail white-text' />
                  </div>
                </div>
              </div>
            </div>
  ...
  renderCheckingHeader (iconName, accountName, availableBalance, currentBalance) {
    return (
      <div className='account-detail-header'>
        <div className='row valign-wrapper'>
          <div className='col s12 m6 left-align text-left'>
            <span style={{verticalAlign: 'middle'}} className='card-title white-text left-align'><span className={iconName} />  {accountName} - <span className='account-num'>{this.state.mask}****</span></span>
          </div>
          <div className='col s12 m6 right-align'>
