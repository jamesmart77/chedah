...
class PlaidLinkMenuItem extends Component {
  constructor(props) {
    super(props);
    this.state = {
      disabledButton: true,
  ...
  render() {
    return (
        <li>
            <a href="#!" onClick={this.handleOnClick} style={menuStyle}>
                <i className="large material-icons">insert_link</i>Link Account
            </a>
            <Script
...
export default PlaidLinkMenuItem;
